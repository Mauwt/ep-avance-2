...
variables_df <- data.frame(
  Variable = c("Altura", "Lleva Accesorios", "Género", "Tamaño del Cabello", 
               ...
               "Tiempo de Reconocimiento", "Color de Prenda Superior", "Clima", "Fallo en el Acceso"),
  ...
  Tipo = c("Numérica continua", "Categórica nominal", "Categórica nominal", "Categórica ordinal", 
           ...
           "Numérica discreta", "Categórica nominal", "Categórica nominal", "Booleana"),
...
df <- df %>%
  rename(
    ...
    temperatura = `Temperatura en C° (usar punto como separador decimal)`,
    distancia_detector = `Distancia entre el detector y la persona en metros (usar punto como separador decimal)`,
